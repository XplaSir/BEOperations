...
urlpatterns = [
    ...
    # E60Transformer urls
    path('e60transformer', E60TransformerGet.as_view(), name="e60transformer"),
    path('e60transformer/<pk>', E60Transformer.as_view(), name="e60transformerid"),
    path('e60transformerpost', E60TransformerPost.as_view(),name="e60transformerpst"),
    ...
    # E60Switchgear urls
    path('e60switchgear', E60SwitchgearGet.as_view(), name="e60switchgear"),
    path('e60switchgear/<pk>', E60Switchgear.as_view(), name="e60switchgearid"),
    ...
    # E60Substation urls
    path('e60substation', E60SubstationgeneralGet.as_view(), name="e60substation"),
    path('e60substation/<pk>', E60Substationgeneral.as_view(),name="e60substationid"),
    path('e60substationpost', E60SubstationgeneralPost.as_view(),name="e60substationpost"),
    path('e60substationdelete/<pk>', E60SubstationgeneralDelete.as_view(),name="e60substationdelete"),
    path('e60substationupdate/<pk>', E60SubstationgeneralUpdate.as_view(),name="e60substationupdate"),

    # E60MeterSwitchGearHousing urls
    path('e60meterswitch', E60MeterswitchgearhousingGet.as_view(),name="e60meterswitch"),
    path('e60meterswitch/<pk>', E60Meterswitchgearhousing.as_view(),name="e60meterswitchid"),
    path('e60meterswitchpost', E60MeterswitchgearhousingPost.as_view(),name="e60meterswitchpost"),
    path('e60meterswitchdelete/<pk>',E60MeterswitchgearhousingDelete.as_view(), name="e60meterswitchdelete"),
    path('e60meterswitchupdate/<pk>',E60MeterswitchgearhousingUpdate.as_view(), name="e60meterswitchupdate"),

    # E60Meter urls
    path('e60meter', E60MeterGet.as_view(), name="e60meter"),
    path('e60meter/<pk>', E60Meter.as_view(), name="e60meterid"),
    path('e60meterpost', E60MeterPost.as_view(), name="e60meterpost"),
    path('e60meterdelete/<pk>', E60MeterDelete.as_view(), name="e60meterdelete"),
    path('e60meterupdate/<pk>', E60MeterUpdate.as_view(), name="e60meterupdate"),
