...
class LightningArresterGet(APIView):
    def get(self, request, pk):
        ...
        '''
        lightningarrester = Lightningarrester.objects.filter(lightning_arrester_id=pk)
...
class SwitchgearGet(APIView):
    def get(self, request, pk):
        ...
        '''
        switchgear = Switchgear.objects.filter(switchgear_id=pk)
...
class E60TransformerPost(APIView):
    def post(self, request):
        serializer = E60Transformer(data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data, status=status.HTTP_201_CREATED)
        else:
...
class E60TransformerUpdate(APIView):
    ...
    def patch(self, pk, request):
        ...
        serializer = E60TransformerSerializers(
            e60transformer, partial=True, data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data)
        else:
...
class E60SwitchgearPost(APIView):
    def post(self, request):
        serializer = E60Switchgear(data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data, status=status.HTTP_201_CREATED)
        else:
...
class E60SwitchgearUpdate(APIView):
    ...
    def patch(self, pk, request):
        ...
        serializer = E60SwitchgearSerializers(
            e60switch, partial=True, data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data)
        else:
...
class E60Substationgeneral(APIView):
    def get(self, request, pk):
        e60substation = E60Substationgeneral.objects.filter(pk=pk)
        serializer = E60SubstationgeneralSerializers(e60substation, many=True).data
        return Response(serializer)
    
class E60SubstationgeneralGet(APIView):
    def get(self, request, format=None):
        e60substation = E60Substationgeneral.objects.all()
        serializer = E60SubstationgeneralSerializers(
...
class E60SubstationgeneralPost(APIView):
    def post(self, request):
        serializer = E60Substationgeneral(data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data, status=status.HTTP_201_CREATED)
        else:
...
class E60SubstationgeneralDelete(APIView):
    ...
    def get_object(self, pk):
        try:
            return E60Substationgeneral.objects.get(pk=pk)
        except E60Substationgeneral.DoesNotExist:
            raise Http404
...
class E60SubstationgeneralUpdate(APIView):
    ...
    def patch(self, pk, request):
        e60substation = self.get_object(pk)
        serializer = E60SubstationgeneralSerializers(
            e60substation, partial=True, data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data)
        else:
...
######################################
#E60METERSWITCHGEARHOUSING
######################################


class E60Meterswitchgearhousing(APIView):
    def get(self, request, pk):
        e60meterswitch = E60Meterswitchgearhousing.objects.filter(pk=pk)
        serializer = E60MeterswitchgearhousingSerializers(e60meterswitch, many=True).data
        return Response(serializer)
    
class E60MeterswitchgearhousingGet(APIView):
    def get(self, request, format=None):
        e60meterswitch = E60Meterswitchgearhousing.objects.all()
        serializer = E60MeterswitchgearhousingSerializers(
            e60meterswitch, many=True).data
        return Response(serializer)


class E60MeterswitchgearhousingPost(APIView):
    def post(self, request):
        serializer = E60Meterswitchgearhousing(data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data, status=status.HTTP_201_CREATED)
        else:
...
class E60MeterswitchgearhousingDelete(APIView):

    def get_object(self, pk):
        try:
            return E60Meterswitchgearhousing.objects.get(pk=pk)
        except E60Meterswitchgearhousing.DoesNotExist:
            raise Http404

    def get(self, request, pk):
        e60meterswitch = self.get_object(pk)
        serializer = E60MeterswitchgearhousingSerializers(
            e60meterswitch, many=True).data
        return Response(serializer)
    ...
    def delete(self, request, pk):
        e60meterswitch = self.get_object(pk)
        e60meterswitch.delete()
        return Response('content deleted successfully', status=status.HTTP_204_NO_CONTENT)


class E60MeterswitchgearhousingUpdate(APIView):
    ...
    def patch(self, pk, request):
        e60meterswitch = self.get_object(pk)
        serializer = E60MeterswitchgearhousingSerializers(
            e60meterswitch, partial=True, data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data)
        else:
...
class E60Meter(APIView):
    def get(self, request, pk):
        e60meter = E60Meter.objects.filter(pk=pk)
        serializer = E60MeterSerializers(e60meter, many=True).data
        return Response(serializer)
    
class E60MeterGet(APIView):
    def get(self, request, format=None):
        e60meter = E60Meter.objects.all()
        serializer = E60MeterSerializers(e60meter, many=True).data
        return Response(serializer)


class E60MeterPost(APIView):
    def post(self, request):
        serializer = E60Meter(data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data, status=status.HTTP_201_CREATED)
        else:
...
class E60MeterDelete(APIView):

    def get_object(self, pk):
        try:
            return E60Meter.objects.get(pk=pk)
        except E60Meter.DoesNotExist:
            raise Http404

    def get(self, request, pk):
        e60meter = self.get_object(pk)
        serializer = E60MeterSerializers(e60meter, many=True).data
        return Response(serializer)
...
class E60MeterUpdate(APIView):
    ...
    def patch(self, pk, request):
        e60meter = self.get_object(pk)
        serializer = E60MeterSerializers(
            e60meter, partial=True, data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data)
        else:
