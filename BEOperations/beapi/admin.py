...
admin.site.register(E60Lightningarrester)
admin.site.register(E60Dfuses)
...
admin.site.register(E60Substationgeneral)
admin.site.register(E60Meterswitchgearhousing)
admin.site.register(E60Meter)
