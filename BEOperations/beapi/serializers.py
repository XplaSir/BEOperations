...
class E60SubstationgeneralSerializers(serializers.ModelSerializer):

    class Meta:
        model = E60Substationgeneral
        fields = '__all__'


class E60MeterswitchgearhousingSerializers(serializers.ModelSerializer):

    class Meta:
        model = E60Meterswitchgearhousing
        fields = '__all__'


class E60MeterSerializers(serializers.ModelSerializer):
...
class E60LightningarresterSerializers(serializers.ModelSerializer):
    class Meta:
        model = E60Lightningarrester
        fields = '__all__'
...
class JobFormSerializer(serializers.ModelSerializer):     
    ...
    def get_assignee_fullname(self, obj):      
        url = "http://172.20.0.70:8082/users/username/" + self.get_assignee_username(obj)
